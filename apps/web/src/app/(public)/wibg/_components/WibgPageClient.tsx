...
const JOURNEY_STEPS = [
  ...
  { num: "02", title: "Full Application",   desc: "Submit your business profile, financials, CAC status, and a 2-minute video pitch link. Tell us why you should win.", date: "Closes May 24" },
  { num: "03", title: "Capacity Webinars",  desc: "Attend intensive Saturday and Sunday training sessions across at least 2 of the 3 August weekends. Mandatory for shortlisting.", date: "Aug 8 – 21" },
  { num: "04", title: "Virtual Semi-Final", desc: "Top 20 applicants pitch virtually to an independent panel. Six finalists are selected for the Grand Finale.", date: "Sept 5" },
  { num: "05", title: "Grand Finale",       desc: "Six finalists pitch live on the SME Mall main stage before 500+ attendees, investors, and press. The best three win.", date: "Sept 12" },
];

const SAT_WEBINARS = [
  { week: "Weekend 1", topic: "Legal",      date: "Sat, August 8", bullets: ["Business registration and licensing", "Contracts and regulatory compliance", "Legal risk management for SMEs"] },
  { week: "Weekend 2", topic: "HR",         date: "Sat, August 13", bullets: ["Employment contracts and payroll", "Staff policies and compliance", "Building people systems for growth"] },
  { week: "Weekend 3", topic: "Technology", date: "Sat, August 20", bullets: ["Digital tools and payment systems", "Business automation and efficiency", "Tech as a competitive advantage"] },
];

const SUN_WEBINARS = [
  { week: "Weekend 1", topic: "Accounting", date: "Sun, August 9",  bullets: ["Bookkeeping and P&L fundamentals", "Tax readiness and compliance", "Financial records that attract lenders"] },
  { week: "Weekend 2", topic: "Marketing",  date: "Sun, August 14", bullets: ["Value proposition and customer targeting", "Digital presence and CRM", "Brand-to-revenue strategy"] },
  { week: "Weekend 3", topic: "Advisory",   date: "Sun, August 21", bullets: ["Business planning and governance", "Growth strategy and scaling", "Accessing funding and expert guidance"] },
];

const FAQS = [
  { q: "What is the WIBG 2026 Pitch Competition?", a: "The Women in Business Grant (WIBG) is a premium capacity-building program and pitch competition for female-led businesses, run in partnership with SME Mall. Six finalists are selected to pitch for ₦3 Million in grants — ₦1.5M first place, ₦1M second, ₦500K third — at the physical Grand Finale on September 12, 2026." },
  ...
  { q: "What are the webinar attendance requirements?", a: "Webinars run across 3 weekends in August. Saturdays cover Business Foundations; Sundays cover Market & Brand Leadership. To remain eligible for shortlisting, you must attend both Saturday and Sunday sessions for at least 2 of the 3 weekends. Attendance is verified via sign-in." },
  ...
  { q: "What are the key deadlines?", a: "Applications open April 1. The deadline to pay the BHC fee, submit your full application, and upload your video pitch is Sunday, May 24, 2026. No extensions. Virtual semi-finals: September 5. Grand Finale: September 12, 2026." },
];
            ...
            <div className="bg-green-500 rounded-3xl p-10 sm:p-12 flex flex-col justify-between min-h-[360px]">
              <div>
                ...
                <p className="text-green-100/70 text-sm leading-relaxed max-w-sm">
                  Complete your BHC diagnostic, submit your application before May 24, and step onto the biggest stage for women-led businesses in Nigeria.
                </p>
              </div>
              <Link
                href="/dashboard/wibg/apply"
            ...
            <div className="bg-white/[0.025] border border-white/[0.08] rounded-3xl p-10 sm:p-12">
              {attendState === "success" ? (
                ...
                <>
                  ...
                  <p className="text-gray-500 text-sm mb-8">Sept 12 · SME Mall Stage · Lagos · 500 seats</p>
