    ...
    <DashboardLayout navItems={navItems}>
      <div className="max-w-5xl space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { label: "Active Jobs",    value: String(active.length),    icon: "🛠️", color: "bg-amber-50",   accent: "text-amber-500" },
            { label: "Completed",      value: String(completed.length), icon: "✅", color: "bg-emerald-50", accent: "text-emerald-500" },
            { label: "Rating",         value: provider ? provider.avgRating.toFixed(1) : "—", icon: "★", color: "bg-blue-50", accent: "text-blue-500" },
          ].map((s) => (
